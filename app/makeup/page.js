    ...
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <h1 className="text-3xl font-bold text-center mb-10 text-gray-900">Makeup Products</h1>
          <div className="flex flex-wrap justify-center -m-4">
            ...
            {products.length === 0 && (
              <p className="text-center w-full text-gray-500">No makeup products available at the moment.</p>
            )}
          </div>
        </div>
      </section>
